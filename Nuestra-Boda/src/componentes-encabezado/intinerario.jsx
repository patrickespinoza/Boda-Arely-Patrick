export default function Intinerario () {
    return (
        ...
        <div class="flex-1 flex flex-col items-center justify-center">
            ...
            <img class="h-24 w-24 sm:h-28 sm:w-28 p-3" src="/public/tarta-de-boda.png" alt="imagen del salon" />
        ...
        <div class="flex-1 flex flex-col items-center justify-center">
            ...
            <img class="h-24 w-24 sm:h-28 sm:w-28 p-3" src="/public/pareja-de-boda.png" alt="dress code" />
